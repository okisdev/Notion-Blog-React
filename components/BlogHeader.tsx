            ...
            <div id='notion-blog-header-content'>
                ...
                <div id='notion-blog-header-description' className='pt-6'>
                    <div className='text-center flex justify-center items-center space-x-2'>
                        <span>
                            Blog built with{' '}
                            <a href='https://notion.so/' className='transition duration-500 underline hover:bg-yellow-500' target='_blank' rel='noopener noreferrer'>
                                Notion
                            </a>
                            ,{' '}
                            <a href='https://reactjs.org/' className='transition duration-500 underline hover:bg-yellow-500' target='_blank' rel='noopener noreferrer'>
                                React
                            </a>
                            ,{' '}
                            <a href='https://nextjs.org/' className='transition duration-500 underline hover:bg-yellow-500' target='_blank' rel='noopener noreferrer'>
                                Next.js
                            </a>
                            ,{' '}
                            <a href='https://tailwindcss.com/' className='transition duration-500 underline hover:bg-yellow-500' target='_blank' rel='noopener noreferrer'>
                                tailwindcss
                            </a>
                            ,{' '}
                            <a href='https://www.typescriptlang.org/' className='transition duration-500 underline hover:bg-yellow-500' target='_blank' rel='noopener noreferrer'>
                                TypeScript
                            </a>
                            ,{' '}
